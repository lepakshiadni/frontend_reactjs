...
import { getBookMarkedPost } from "../../../../redux/action/employers.action";
...
const EmployerFeed = () => {
  ...
  console.log('bookmark', bookMarkedPost);
      ...
      <div className="feed">
        <section className="centered-section">
          <div className="centered-content">
            ...
            {/* <p style={{ fontSize: '12px', marginTop: '10px', color: '#6A6A6A', display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>{employer?.skills.map((data) => (<p className='ms-1'> {data} || </p>))}</p> */}
          </div>
          <section>
