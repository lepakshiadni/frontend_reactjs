...
const TrainerFeeData = ({ PostTrainingData }) => {
    ...
    const handleIconClick2 = (index) => {
        const updatedSelectedItems2 = [...selectedItems2];
        updatedSelectedItems2[index] = !updatedSelectedItems2[index];
        setSelectedItems2(updatedSelectedItems2);
    };
    ...
    const toggleHandleMessageMore = (index, selectedpostDetails) => {
    ...
    const handleViewMoreComments = (index) => {
        ...
        if (numCommentsToShow + 4 >= comments.length) {
    ...
    const deleteComment = (index) => {
        ...
        newData.splice(index, 1); // Remove the comment at the specified index
                ...
                {PostTrainingData?.map((post, index) => (
                    <div key={index}>
                        <div className='centered-section2'>
                            ...
                            <p
                                ...
                                <div className='skilldata2'>
                                    <h5><span className='skillchild'>Type of training -</span> <span className='skillchild2'>{post.typrOfTraining}</span></h5>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                                        ...
                                        <div className='skillfooter2'>
                                            <div onClick={() => handleIconClick2(index)}>
                                            ...
                                            <svg className='comments' xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none" onClick={() => toggleHandleMessageMore(index, post)} style={{ cursor: 'pointer' }}>
                                ...
                                <section>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
                                        ...
                                        <div className='skillFooter'>
                                            <p style={{ color: '#2676C2', fontWeight: '400px', margin: '0px' }}>₹ {post.minBudget} - ₹ {post.maxBudget}</p>
                                            <p style={{ margin: '0px' }}> <span style={{ color: 'gray' }}>Mode of Training</span> <span style={{ color: '#2676C2', fontWeight: '400px' }}>- {post.modOfTraining}</span> </p>
                                        </div>
                                        <div className='skillfooter2'>
                                            <div onClick={() => handleIconClick2(index)}>
                                                {selectedItems2[index] ? (
                                            ...
                                            <svg className='comments' xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none" style={{ cursor: 'pointer' }}
                                                onClick={() => toggleHandleMessageMore(index, post)}
                                            >
                                                <path d="M3.59961 16.9203L5.12357 15.7012L5.13478 15.6926C5.45249 15.4384 5.61281 15.3101 5.79168 15.2188C5.95216 15.1368 6.12328 15.0771 6.2998 15.0408C6.49877 15 6.70603 15 7.12207 15H15.8031C16.921 15 17.4806 15 17.908 14.7822C18.2843 14.5905 18.5905 14.2842 18.7822 13.9079C19 13.4805 19 12.9215 19 11.8036V4.19691C19 3.07899 19 2.5192 18.7822 2.0918C18.5905 1.71547 18.2837 1.40973 17.9074 1.21799C17.4796 1 16.9203 1 15.8002 1H4.2002C3.08009 1 2.51962 1 2.0918 1.21799C1.71547 1.40973 1.40973 1.71547 1.21799 2.0918C1 2.51962 1 3.08009 1 4.2002V15.6712C1 16.7369 1 17.2696 1.21846 17.5433C1.40845 17.7813 1.69644 17.9198 2.00098 17.9195C2.35115 17.9191 2.76744 17.5861 3.59961 16.9203Z" stroke="#8D8D8D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <div style={{ width: '650px' }}>
                            {!messageShowMoreBasedOnProfile[index] ? null : (
                                <div>
                                    <div className='messageFooter'>
                                        ...
                                        {showAllComments[index] ? (
                                                            ...
                                                            <div style={{ display: 'flex' }}>
                                                                ...
                                                                <div style={{ position: 'static', display: 'inline-block' }}>
                                                                    <div ref={menuRef3}
                                                                        ...
                                                                        style={{ cursor: 'pointer', fontSize: '25px', fontWeight: 'bolder', color: 'gray', marginLeft: '360px' }}>⋮</div>
                                                                    {open3Array[index] && (
                                                                        <div style={{ position: 'absolute', top: '61%', right: 250, background: 'white', border: '1px solid #ccc', borderRadius: '5px', zIndex: 1, width: '100px' }}>
                                                                            <div className='option' style={{ padding: '5px 30px', cursor: 'pointer', fontSize: '12px' }} onClick={() => deleteComment(index)}>Delete</div>
                                            ...
                                            <div>
                                                ...
                                                {comments?.slice(0, numCommentsToShow).map((item, index) => (
                                                    <div key={index} style={{ display: 'flex', margin: '5px', marginTop: '10px' }}>
                                                        <img className='img2' height='40px' width='40px' src={item?.imageUrl} alt="" />
                                                        <div style={{ width: "436px", height: '96px', backgroundColor: '#f0f0f0', padding: '10px', marginLeft: '10px', borderStartEndRadius: '15px', borderEndStartRadius: '15px', borderEndEndRadius: '15px', border: '2px solid #E9E9E9' }}>
                                                            <div style={{ display: 'flex' }}>
                                                                ...
                                                                <div style={{ position: 'relative', display: 'inline-block' }}>
                                                                    <div
                                                                        ref={menuRef3}
                                                                        onClick={() => toggleDropdown(index)}
                                                                        style={{ cursor: 'pointer', fontSize: '25px', fontWeight: 'bolder', color: 'gray', marginLeft: '360px' }}
                                                                    >
                                                                        ⋮
                                                                    </div>
                                                                    {open3Array[index] && (
                                                                        <div
                                                                            style={{
                                                                                ...
                                                                                left: 270, // Adjust this value as needed
                                                                                background: 'white',
                                                                                border: '1px solid #ccc',
                                                                                borderRadius: '5px',
                                                                                zIndex: 9999,
                                        ...
                                        {!showAllComments[index] && numCommentsToShow < comments?.length && (
                                            <h6
