...
import { addBookMarkePost } from '../../../../redux/action/trainer.action'
import { getPostTrainingRequirementAction, addPostTrainingComments, getPostTrainingComments,addlikePostTraining } from '../../../../redux/action/postRequirement.action'
...
const TrainerFeeData = ({ PostTrainingData }) => {
    ...
    const handleIconClick2 = (index,postId) => {
        ...
        dispatch(addlikePostTraining(currentUserId,postId))
    };
                                        ...
                                        <div className='skilldata2'>
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                                                ...
                                                <div className='skillfooter2'>
                                                    <div onClick={() => handleIconClick2(index,post?._id)}>
