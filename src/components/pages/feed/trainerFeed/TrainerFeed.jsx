...
import { getBookMarkedPost,createConversation } from '../../../../redux/action/trainer.action'
            ...
            <div className="feed">
                ...
                <section className="centered-section">
                    <div className="centered-content">
                        ...
                        <h3 style={{ marginTop: '15px', fontSize: '20px', color: '#263238' }}>{trainer?.fullName}</h3>
                        ...
                        <section ref={showmoreRef} className='scroll' style={{ border: '1px solid #EEEEEE', padding: '10px', height: '300px', marginTop: '10px' }}>
                            ...
                            {bookMarkedPost?.postDetails?.length > 0 ? <>
                                ...
                                <div className='flex flex-col ml-[48px] gap-1 '>
                                    <Skeleton className='rounded-sm' variant="rectangular" width={250} height={60} />
                                    <Skeleton variant="text" width={250} sx={{ fontSize: '1rem' }} />
                                    <Skeleton variant="text" width={250} sx={{ fontSize: '1rem' }} />
                                    <Skeleton variant="text" width={250} sx={{ fontSize: '1rem' }} />
                                    <Skeleton variant="text" width={250} sx={{ fontSize: '1rem' }} />
