  ...
  return (
    <div className="trinersHelp ">
      ...
      {!openModal && (
        <div>
          <div>
            <div className='flex items-center' style={{ border: '2px solid #D1D1D1', borderRadius: '5px' }} >
              <svg className='ms-4' xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
              ...
              <input style={{ width: '1020px', height: '50px', color: '#888888', borderLeft: 'none', cursor: 'pointer' }} className='ps-3 outline-none ' type="text" placeholder='Search help articles by keywords'
                onChange={(e) => setFilterText(e.target.value)}
                onClick={() => setSearchOpen(!searchOpen)} />
            </div>
 
            {searchOpen ? (
              <div className='searchMenu' style={{ position: 'absolute', width: '1020px', zIndex: "10" }}>
          ...
          <div className='flex flex-wrap'>
            ...
            <div style={{ backgroundColor: "rgba(38, 118, 194, 0.2)", width: '259px', height: '120px', borderRadius: '8px', borderWidth: '1px' }} className='helpMenu me-5 mt-5' onClick={() => { handleOpen('open') }}>
              <div style={{ paddingLeft: '13px', paddingTop: "20px" }} className='flex items-start'>
            ...
            <div style={{ backgroundColor: "rgba(38, 118, 194, 0.2)", width: '259px', height: '120px', borderRadius: '8px', borderWidth: '1px' }} className='helpMenu me-5 mt-5 ' onClick={() => handleOpen('open3')}>
              <div style={{ paddingLeft: '13px', paddingTop: "20px" }} className='flex items-start'>
                <div style={{ width: '36px', height: '36px' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                    <circle cx="18" cy="18" r="18" fill="#2676C2" />
                    <path d="M18 28V25.7778H25.7778V10.2222H18V8H25.7778C26.3889 8 26.912 8.21759 27.3472 8.65278C27.7824 9.08796 28 9.61111 28 10.2222V25.7778C28 26.3889 27.7824 26.912 27.3472 27.3472C26.912 27.7824 26.3889 28 25.7778 28H18ZM15.7778 23.5556L14.25 21.9444L17.0833 19.1111H8V16.8889H17.0833L14.25 14.0556L15.7778 12.4444L21.3333 18L15.7778 23.5556Z" fill="white" />
                  </svg>
                </div>
                <div style={{ color: '#2676C2', marginLeft: '14px' }}>
                  <h6 style={{ fontSize: '16px', fontWeight: '500' }}>Log in</h6>
                  <p style={{ fontSize: '12px', fontWeight: '400' }}>We're excited to announce a <br />
          ...
          <div>
            <h3 style={{ fontSize: '20px', fontWeight: '500', margin: '10px 0px' }}>Most Asked FAQ’s</h3>
            <div style={{ height: '456px', width: '1020px', border: '1px solid #D1D1D1' }}>
 
              <div className='questionMenu' >
                <h6>What is Sissoo, and how can it benefit me?</h6>
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="15" viewBox="0 0 17 15" fill="none">
                  <path d="M1 7.42857L16 7.42857M16 7.42857L9.57143 1M16 7.42857L9.57143 13.8571" stroke="#535353" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
              <hr />
              <div className='questionMenu'>
