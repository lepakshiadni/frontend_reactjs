...
const HelpPage5 = (props) => {
    ...
    return (
        <div style={{ display: 'flex', margin: '20px' }}>
            ...
            <div className='fixed'>
                <div style={{ fontSize: '16px', fontWeight: '400', color: '#1E1E1E', display: 'flex', alignItems: 'center', cursor: 'pointer', margin: "10px 0px" }} onClick={() => { setOpen5(false); setOpenModal(false) }}>
