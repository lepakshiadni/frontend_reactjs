...
const HelpPage4 = (props) => {
    const setOpen4 = props.setOpen4
    ...
    return (
        <div style={{ display: 'flex', margin: '20px' }}>
            <div className='fixed'>
                <div style={{ fontSize: '16px', fontWeight: '400', color: '#1E1E1E', display: 'flex', alignItems: 'center', cursor: 'pointer', margin: "10px 0px" }} onClick={() => { setOpen4(false); setOpenModal(false) }}>
